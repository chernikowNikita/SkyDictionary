...
class MeaningVC: UIViewController {
    ...
    // MARK: - Create
    public static func Create(viewModel: MeaningVM) -> MeaningVC {
        let vc = R.Storyboard.main.instantiateViewController(withIdentifier: String(describing: self)) as! MeaningVC
